$(document).ready(function () {
	...
	$("#createBtn").click(function () {
		...
		if (counter == 0) {
			alert(
				"A minimum of one track or artist must be entered to create the playlist."
			);
		} else {
	...
	function createSelected(label, value) {
		$("#selectedItems").append(
			'<a class="list-group-item"><span class="float-left selected-search" data-id="' +
				value +
				'">' +
				label +
				'</span><span class="float-right"><span class="btn btn-xs btn-default" onclick="removeSelected(this);"><i class="far fa-times-circle"></i></span></span></a>'
		);
	}
